...
WebUI.click(findTestObject('Object Repository/Page_Course 1/a_Announcements  Forum'))

WebUI.click(findTestObject('Object Repository/Page_Announcements/a_Add discussion topic'))

WebUI.setText(findTestObject('Object Repository/Page_Announcements/input_Subject_subject'), '1')

WebUI.setText(findTestObject('Object Repository/Page_Announcements/div_1'), '<p dir="ltr" style="text-align: left;">1</p>')

WebUI.click(findTestObject('Object Repository/Page_Announcements/input_Rich text editor_submitbutton'))
