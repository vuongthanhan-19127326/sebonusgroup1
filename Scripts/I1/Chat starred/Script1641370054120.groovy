...
WebUI.setText(findTestObject('Object Repository/Page_L Tm Anh Log in to the site/input_Username_username'), 'admin3')
...
WebUI.click(findTestObject('Object Repository/Page_Dashboard/p_Anh Lee_m-0 font-weight-light text-trunca_061f33'))

WebUI.setText(findTestObject('Object Repository/Page_Dashboard/textarea_Use enter to send_yui_3_17_2_1_164_c5ba4e'), 'aa')
