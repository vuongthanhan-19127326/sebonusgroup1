...
WebUI.click(findTestObject('Object Repository/Page_Dashboard/a_Delete conversation'))

WebUI.click(findTestObject('Object Repository/Page_Dashboard/button_Delete'))
