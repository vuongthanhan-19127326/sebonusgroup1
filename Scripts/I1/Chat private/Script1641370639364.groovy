...
WebUI.click(findTestObject('Object Repository/Page_Dashboard/span_sdasd'))

WebUI.click(findTestObject('Object Repository/Page_Dashboard/button__btn btn-link btn-icon icon-size-3 ml-1'))
