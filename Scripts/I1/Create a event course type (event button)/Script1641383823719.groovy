...
WebUI.setText(findTestObject('Object Repository/Page_Dashboard/input_Event title_name'), '3')

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Dashboard/select_1        2        3        4        _45ea30'), 
    '6', true)

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Dashboard/select_User            Course            Ca_edc569'), 
    'course', true)

WebUI.click(findTestObject('Object Repository/Page_Dashboard/span_'))

WebUI.click(findTestObject('Object Repository/Page_Dashboard/li_1'))

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Dashboard/select_1'), '2', true)
