...
WebUI.click(findTestObject('Object Repository/Page_Announcements/input_Subject_subject'))

WebUI.click(findTestObject('Object Repository/Page_Announcements/button_Cancel'))
