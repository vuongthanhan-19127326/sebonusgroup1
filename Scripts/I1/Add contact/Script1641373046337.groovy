...
WebUI.setText(findTestObject('Object Repository/Page_Dashboard/input_Messages selected_form-control'), 'Anh Lee')
...
WebUI.click(findTestObject('Object Repository/Page_Dashboard/i_Anh Lee_icon fa fa-ellipsis-h fa-fw'))

WebUI.click(findTestObject('Object Repository/Page_Dashboard/a_User info'))

WebUI.click(findTestObject('Object Repository/Page_Dashboard/button_Add to contacts'))

WebUI.click(findTestObject('Object Repository/Page_Dashboard/button_Add'))
