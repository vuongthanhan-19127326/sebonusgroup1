...
WebUI.click(findTestObject('Object Repository/Page_My courses/div_Course category                        _27197e'))
...
WebUI.scrollToElement(findTestObject('Page_1 Deadline 1 - Edit submission/input_Loading_cancel'), 0)

WebUI.click(findTestObject('Object Repository/Page_1 Deadline 1 - Edit submission/input_Loading_cancel'))
