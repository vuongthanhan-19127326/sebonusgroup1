...
WebUI.click(findTestObject('Object Repository/Page_Dashboard/a_AU'))

WebUI.click(findTestObject('Object Repository/Page_Dashboard/a_Profile'))

WebUI.click(findTestObject('Object Repository/Page_Admin User Public profile/a_Edit profile'))

WebUI.scrollToElement(findTestObject('Object Repository/Page_Anh Lee Edit profile/input_Address_submitbutton'), 0)

WebUI.click(findTestObject('Object Repository/Page_Anh Lee Edit profile/input_Address_submitbutton'))
