...
WebUI.click(findTestObject('Object Repository/Page_1 Deadline 1/button_Remove submission'))

WebUI.click(findTestObject('Object Repository/Page_1 Deadline 1/button_Continue'))
