...
WebUI.click(findTestObject('Object Repository/Page_Dashboard/i_Site administration_icon fa fa-bell-o fa-fw'))

WebUI.click(findTestObject('Object Repository/Page_Dashboard/a_View full notification'))
