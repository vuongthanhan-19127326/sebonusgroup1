...
WebUI.scrollToElement(findTestObject('Page_Anh Lee Edit profile/input_Address_cancel'), 0)

WebUI.click(findTestObject('Object Repository/Page_Anh Lee Edit profile/input_Address_cancel'))
