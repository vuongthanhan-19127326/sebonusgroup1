...
WebUI.click(findTestObject('Object Repository/Page_Dashboard/a_T1'))

WebUI.click(findTestObject('Object Repository/Page_Dashboard/a_Grades'))

WebUI.click(findTestObject('Object Repository/Page_Grades - Thien 1/a_1'))
