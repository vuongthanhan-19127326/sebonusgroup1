...
class __Mustache_dc3a154f8fea8c4d5bc2fe8548fe11de extends Mustache_Template
{
...
';
        ...
        // 'str' section
        $value = $context->find('str');
        $buffer .= $this->section22ac30a00409bc92f4c7aff775b9c481($context, $indent, $value);
        $buffer .= '</button>
';
...
';
    ...
    private function section22ac30a00409bc92f4c7aff775b9c481(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
