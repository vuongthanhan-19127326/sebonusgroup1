...
class __Mustache_472937df600c6460cdd60fbc579624ae extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionC7ab4ec20db98c2e695016207a6b5433($context, $indent, $value);
        // 'urls.noevents' inverted section
        $value = $context->findDot('urls.noevents');
        if (empty($value)) {
            
            $buffer .= $indent . '    <div class="hidden text-xs-left text-left mt-3" data-region="empty-message">
';
...
';
    ...
    private function sectionC7ab4ec20db98c2e695016207a6b5433(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
