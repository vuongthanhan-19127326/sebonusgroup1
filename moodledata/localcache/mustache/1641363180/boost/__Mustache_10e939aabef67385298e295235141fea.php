...
class __Mustache_10e939aabef67385298e295235141fea extends Mustache_Template
{
...
';
        $buffer .= $indent . '            <butaaan class="fp-file-update btn-primary btn">';
        // 'str' section
        $value = $context->find('str');
        $buffer .= $this->section47d66f004044b857c042bbdf70fe2cc2($context, $indent, $value);
        $buffer .= '</button>
';
        $buffer .= $indent . '            <aaa class="fp-file-cancel btn-secondary btn">';
        // 'str' section
        $value = $context->find('str');
