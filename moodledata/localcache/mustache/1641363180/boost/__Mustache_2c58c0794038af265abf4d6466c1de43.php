...
class __Mustache_2c58c0794038af265abf4d6466c1de43 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section99950905ba81f20163f996a4bb20dcb5($context, $indent, $value);
        // 'logourl' section
        $value = $context->find('logourl');
        $buffer .= $this->section8b04704a8157e9e676211ecd0795e04c($context, $indent, $value);
...
';
        ...
        $buffer .= $this->sectionF70c686d3e5f85d6de3ad22fc72cf6ea($context, $indent, $value);
...
';
        ...
        $buffer .= $this->sectionD93f707d01ff987b65fdc6803207eb37($context, $indent, $value);
...
';
        $buffer .= $indent . '    <div class="login-cookiemessage">
';
        $buffer .= $indent . '        ';
        // 'str' section
        $value = $context->find('str');
...
';
    ...
    private function section99950905ba81f20163f996a4bb20dcb5(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section8b04704a8157e9e676211ecd0795e04c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        <div id="loginlogo" class="login-logo">
            ...
            <h1 class="login-heading sr-only">{{sitename}} {{#str}} login {{/str}}</h1>
        </div>
    ';
            $result = call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
...
';
    ...
    private function sectionF70c686d3e5f85d6de3ad22fc72cf6ea(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '            <div class="login-form-rememberusername form-group">
';
                $buffer .= $indent . '                <div class="custom-control custom-checkbox">
';
                $buffer .= $indent . '                    <input type="checkbox" name="rememberusername" id="rememberusername" class="custom-control-input" value="1"
';
                $buffer .= $indent . '                        ';
                // 'username' section
                ...
                $buffer .= ' />
';
                $buffer .= $indent . '                    <label class="custom-control-label" for="rememberusername">';
                // 'str' section
                $value = $context->find('str');
...
';
    ...
    private function section0a9ec9ac0561fec3a3ce27b5c7cd74a9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '                <a class="btn login-identityprovider-btn" href="';
...
';
    ...
    private function sectionD93f707d01ff987b65fdc6803207eb37(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section0a9ec9ac0561fec3a3ce27b5c7cd74a9($context, $indent, $value);
                $buffer .= $indent . '        </div>
';
                $context->pop();
            }
