...
class __Mustache_a9dbdfcbcbefdc6fac5468160532ddd1 extends Mustache_Template
{
...
';
        if ($parent = $this->mustache->loadPartial('theme_boost/drawer')) {
            $context->pushBlockContext(array(
                ...
                'drawerheading' => array($this, 'blockC38b3649f7b22599d01b29b42f5050f2'),
                'drawercontent' => array($this, 'block86609ee50a68b88fde3fb38b778a3a54'),
...
';
    ...
    public function blockC38b3649f7b22599d01b29b42f5050f2($context)
    {
        $indent = $buffer = '';
...
';
    ...
    public function block86609ee50a68b88fde3fb38b778a3a54($context)
    {
        $indent = $buffer = '';
        $buffer .= $indent . '        <div class="list-group">
';
        // 'mobileprimarynav' section
