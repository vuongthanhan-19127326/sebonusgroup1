...
class __Mustache_6ac8c79369a2321e5c909305ee5902f5 extends Mustache_Template
{
...
';
        // 'addoverride' section
        $value = $context->find('addoverride');
        $buffer .= $this->sectionF98831f49ac3e4fd9d823de5a6eee4ba($context, $indent, $value);
        $buffer .= $indent . '        </div>
';
        $buffer .= $indent . '    </div>
';
...
';
    ...
    private function sectionF98831f49ac3e4fd9d823de5a6eee4ba(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
