...
class __Mustache_602cb9fb96b630994edfe493627d5a0f extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionF81e0f4220ef979d6746cd5ffb25d2bb($context, $indent, $value);
        $buffer .= $indent . '                    </select>
';
        $buffer .= $indent . '                </div>
';
...
';
    ...
    private function sectionC6384eae668ae6b448937ea5f8e672fe(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionF81e0f4220ef979d6746cd5ffb25d2bb(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionC6384eae668ae6b448937ea5f8e672fe($context, $indent, $value);
