...
class __Mustache_76aefddddc16922f36e6d377e526134d extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionAe99927fc668eddd5f73dc8e3f5d4e3a($context, $indent, $value);
        $buffer .= $indent . '</div>
';
...
';
    ...
    private function sectionAe99927fc668eddd5f73dc8e3f5d4e3a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        <div class="{{classes}} d-flex "{{#attributes}} {{name}}="{{value}}"{{/attributes}}>
            ...
            {{^prioritise}}
                <aaaaa class="action-menu-trigger">
...
';
                ...
                if (empty($value)) {
                    ...
                    $buffer .= $indent . '                <aaaaa class="action-menu-trigger">
';
                    if ($partial = $this->mustache->loadPartial('core/action_menu_trigger')) {
                        $buffer .= $partial->renderInternal($context, $indent . '                    ');
                    }
