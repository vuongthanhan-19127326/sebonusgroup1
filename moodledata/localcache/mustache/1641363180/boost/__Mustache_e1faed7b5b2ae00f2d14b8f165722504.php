...
class __Mustache_e1faed7b5b2ae00f2d14b8f165722504 extends Mustache_Template
{
...
';
            $buffer .= $indent . '            </a>
';
            $buffer .= $indent . '            <aa id="user-action-menu" class="dsadasdasdenu-right">
';
            $buffer .= $indent . '                <aaa id="usermenu-carousel" class="caádasdasd slide" data-touch="false" data-interval="false" data-keyboard="false">
';
